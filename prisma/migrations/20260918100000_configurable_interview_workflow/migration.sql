...
CREATE TYPE "InterviewRoundProgressStatus" AS ENUM ('PENDING','SCHEDULED','LIVE','ENDED_PENDING_FEEDBACK','ROUND_COMPLETE','TRANSFERRED','FINAL_ROUND_COMPLETE','CANCELLED');
