...
CREATE TABLE "CodingProblem" ("id" TEXT NOT NULL, "slug" TEXT NOT NULL, "title" TEXT NOT NULL, "difficulty" "CodingDifficulty" NOT NULL DEFAULT 'MEDIUM', "category" TEXT NOT NULL DEFAULT 'algorithms', "description" TEXT NOT NULL, "starterCode" JSONB NOT NULL, "solutionTemplate" JSONB, "timeLimitMs" INTEGER NOT NULL DEFAULT 2000, "memoryLimitMb" INTEGER NOT NULL DEFAULT 128, "isActive" BOOLEAN NOT NULL DEFAULT true, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP(3) NOT NULL, CONSTRAINT "CodingProblem_pkey" PRIMARY KEY ("id"));
CREATE TABLE "TestCase" ("id" TEXT NOT NULL, "problemId" TEXT NOT NULL, "input" TEXT NOT NULL, "expectedOutput" TEXT NOT NULL, "isHidden" BOOLEAN NOT NULL DEFAULT false, "weight" INTEGER NOT NULL DEFAULT 1, "orderIndex" INTEGER NOT NULL DEFAULT 0, CONSTRAINT "TestCase_pkey" PRIMARY KEY ("id"));
CREATE TABLE "CodingSubmission" ("id" TEXT NOT NULL, "candidateProfileId" TEXT NOT NULL, "problemId" TEXT NOT NULL, "language" TEXT NOT NULL, "code" TEXT NOT NULL, "status" "SubmissionStatus" NOT NULL DEFAULT 'PENDING', "score" INTEGER NOT NULL DEFAULT 0, "passedTests" INTEGER NOT NULL DEFAULT 0, "totalTests" INTEGER NOT NULL DEFAULT 0, "runtimeMs" INTEGER, "memoryMb" DOUBLE PRECISION, "stdout" TEXT, "stderr" TEXT, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "CodingSubmission_pkey" PRIMARY KEY ("id"));
CREATE TABLE "TypingAssessment" ("id" TEXT NOT NULL, "candidateProfileId" TEXT NOT NULL, "wpm" INTEGER NOT NULL, "accuracy" DOUBLE PRECISION NOT NULL, "errorCount" INTEGER NOT NULL, "durationSeconds" INTEGER NOT NULL, "promptText" TEXT NOT NULL, "typedText" TEXT NOT NULL, "certificateId" TEXT NOT NULL, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "TypingAssessment_pkey" PRIMARY KEY ("id"));
CREATE TABLE "MockInterviewSession" ("id" TEXT NOT NULL, "candidateProfileId" TEXT NOT NULL, "roleTarget" TEXT NOT NULL, "status" "MockInterviewStatus" NOT NULL DEFAULT 'IN_PROGRESS', "totalQuestions" INTEGER NOT NULL DEFAULT 5, "currentQuestionIndex" INTEGER NOT NULL DEFAULT 0, "overallScore" INTEGER, "communicationScore" INTEGER, "technicalScore" INTEGER, "integrityScore" INTEGER, "aiFeedback" TEXT, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP(3) NOT NULL, CONSTRAINT "MockInterviewSession_pkey" PRIMARY KEY ("id"));
CREATE TABLE "MockInterviewTurn" ("id" TEXT NOT NULL, "sessionId" TEXT NOT NULL, "questionIndex" INTEGER NOT NULL, "questionText" TEXT NOT NULL, "candidateAnswerTranscript" TEXT, "score" INTEGER, "feedback" TEXT, "turnLatencyMs" INTEGER, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "MockInterviewTurn_pkey" PRIMARY KEY ("id"));
...
CREATE INDEX "MockInterviewTurn_sessionId_questionIndex_idx" ON "MockInterviewTurn"("sessionId", "questionIndex");
