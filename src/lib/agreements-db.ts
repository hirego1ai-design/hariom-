...
// ----------------------------------------------------------------------------
// DEVELOPMENT/TEST FALLBACK STATE
// ----------------------------------------------------------------------------
// Keep fallback collections empty. Synthetic companies, candidates, contacts,
// commercial terms, and operational records must live in test fixtures only.
