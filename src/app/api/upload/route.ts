...
export async function POST(req: NextRequest) {
  try {
    ...
    const allowedCategoriesByRole: Record<string, Set<string>> = {
      ...
      EMPLOYER: new Set(["avatars", "company-logos", "employer-docs", "offer-docs", "assessment-media"]),
      RECRUITER: new Set(["avatars", "company-logos", "employer-docs", "offer-docs", "assessment-media"]),
      ADMIN: new Set(["resumes", "avatars", "onboarding-docs", "video-resumes", "company-logos", "employer-docs", "offer-docs", "assessment-media"]),
    };
