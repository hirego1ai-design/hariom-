      ...
      <div className="max-w-3xl mx-auto py-8 px-4">
        ...
        <form onSubmit={submit} className="glass-card rounded-2xl p-6 space-y-5">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <label className="block text-sm text-text-secondary">
              Configured round ID
              <input value={roundId} onChange={(e) => setRoundId(e.target.value)} className="mt-2 w-full input-pill h-11 px-4 text-white" placeholder="Select a configured interview round" />
            </label>
            <label className="block text-sm text-text-secondary">
              Date
