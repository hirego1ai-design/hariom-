...
test('AI execution accounting and worker safety (isolated contracts)', async (t) => {
  ...
  try {
    ...
    await t.test('included subscription AI does not require customer AI credits', async () => {
    ...
    await t.test('duplicate execution cannot repeat provider call or alter customer credits', async () => {
    ...
    await t.test('pre-execution persistence failure releases internal reservation without customer credit mutation', async () => {
