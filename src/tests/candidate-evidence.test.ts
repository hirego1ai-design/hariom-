...
const application = {
  ...
  candidateProfile: { id: "candidate-a", headline: "Engineer", bio: "Candidate supplied bio", location: "Delhi",
    ...
    availabilityStatus: "AVAILABLE", lastAvailabilityConfirmedAt: null,
    readinessRecords: [] as { roleTitle: string; seniority: string; score: number | null; validUntil: Date | null }[] },
  job: { title: "Engineer" },
};
