...
export default function MarketingFooter() {
  return <footer className="border-t border-white/10 bg-[#071322] text-white">
    <div className="mx-auto grid max-w-[1280px] gap-10 px-5 py-16 sm:px-8 lg:grid-cols-[1.6fr_repeat(5,minmax(0,1fr))]">
      <div><Link href="/" className="inline-block rounded focus-visible:outline focus-visible:outline-2 focus-visible:outline-cyan-300" aria-label="HireGo AI homepage"><Image src="/marketing/hirego-logo-hd.png" alt="HireGo AI" width={180} height={60} className="h-auto w-[180px]" sizes="180px" /></Link><p className="mt-4 max-w-xs text-sm leading-6 text-slate-300">Connected hiring operations, with people responsible for hiring decisions.</p></div>
